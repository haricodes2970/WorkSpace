...
export function IdeasWorkspace({ ideas }: IdeasWorkspaceProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 px-6 py-4 border-b border-[--color-border-subtle] bg-[--color-panel] shrink-0">
        <h1 className="text-[15px] font-semibold text-[--color-text-primary] mr-2">Ideas</h1>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className="text-[13px] font-medium text-[--color-text-primary] truncate group-hover:text-[--color-text-primary]">
          {idea.title}
        </p>
        {idea.description && (
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-2">
        <p className="text-[13px] font-medium text-[--color-text-primary] line-clamp-2 group-hover:text-[--color-text-primary]">
          {idea.title}
        </p>
